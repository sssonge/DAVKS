...
io.popen("mkdir DEVA_Files")
t = "\27[35m".."\nAll Files Started : \n____________________\n"..'\27[m'
i = 0
for v in io.popen('ls DEVAKS_Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if tonumber(user_id) == tonumber(1660459490) then  
var = true  
elseif tonumber(user_id) == tonumber(1660459490) then
var = true  
...
local UserName = (data.username_ or "tttsst")
local NameUser = "[- Twanty 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/tttsst)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Twanty 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/tttsst)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if result.id_ == tonumber(1660459490) then
...
if userid == tonumber(1660459490) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1660459490) then
...
send(msg.chat_id_, msg.id_,"[- Twanty 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/tttsst)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "tttsst")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if DAVKSrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- Twanty 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/tttsst)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "tttsst")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."DAVKS:Special:User"..msg.chat_id_,result.id_)  
...
function Function_DAVKS(extra, result, success)
if result.sender_user_id_ == tonumber(1660459490) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1660459490) then
...
local UserName = (b.username_ or "tttsst")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Twanty TeAM .',url="t.me/tttsst"}},
}
local msg_id = msg.id_/2097152/0.5
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴛᴡᴀɴᴛʏ\n\n[-  ᴛᴡᴀɴᴛʏ ᴄʜᴀɴɴᴇʟ  .](http://t.me/tttsst)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/tttsst)\n\n[-  ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴡᴀɴᴛʏ  .](http://t.me/aaaoao)\n\n[-  ʙᴏᴛ ʜᴏɴʙᴏᴛ .ث](http://t.me/B82bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ʜᴏɴʙᴏᴛ sᴏᴜʀᴄʀ .',url="https://t.me/tttsst/50"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/tttsst&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
inline = {
{{text = '⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/tttsst'}},
}
...
inline = {
{{text = '⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/tttsst'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
