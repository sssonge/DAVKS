...
local t = json:decode(https.request('http://klanrplay.ml/API/index.php?id='..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write")))
print("::DAVKS::")
local RunBot = io.open("DAVKS", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/DAVKS
