...
>> The Bot is Running
>> Bot source > DAVKS
>>Source channel > @HHIHUUI
>>Source developer > @BH_U1
...
if tonumber(user_id) == tonumber(1692631901) then  
var = true  
elseif tonumber(user_id) == tonumber(1692631901) then
var = true  
...
local UserName = (data.username_ or "HHIHUUI")
local NameUser = "[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HHIHUUI)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HHIHUUI)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if result.id_ == tonumber(1692631901) then
...
if userid == tonumber(1692631901) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if userid == tonumber(1692631901) then
...
send(msg.chat_id_, msg.id_,"[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HHIHUUI)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "HHIHUUI")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if DAVKSrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/HHIHUUI)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "HHIHUUI")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."DAVKS:Special:User"..msg.chat_id_,result.id_)  
...
function Function_DAVKS(extra, result, success)
if result.sender_user_id_ == tonumber(1692631901) then
send(msg.chat_id_, msg.id_, "⌔︙لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
if result.sender_user_id_ == tonumber(1692631901) then
...
local UserName = (b.username_ or "HHIHUUI")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- DAVKS TeAM .',url="t.me/HHIHUUI"}},
}
local msg_id = msg.id_/2097152/0.5
...
[⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/HHIHUUI)
     
[⌔︙ DAVKS Developer .](http://t.me/BH_U1)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
inline = {
{{text = '⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/HHIHUUI'}},
}
...
inline = {
{{text = '⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/HHIHUUI'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
