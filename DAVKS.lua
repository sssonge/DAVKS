...
local UserName = (data.username_ or "BxxDx")
local NameUser = "[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/BxxDx)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/BxxDx)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/BxxDx)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "BxxDx")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if DAVKSrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/BxxDx)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "BxxDx")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."DAVKS:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "BxxDx")
...
if text == (database:get(bot_id.."DAVKS:Name:Bot") or "كراند") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."DAVKS:Name:Bot") or "كراند")
local namebot = {
...
if text == 'الملفات' and DevDAVKS(msg) then
t = '⌔︙جميع الملفات : \n — — — — — — — — — \n'
i = 0
for v in io.popen('ls DAVKS_Files'):lines() do
if v:match(".lua$") then
...
if DevDAVKS(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SourceDAVKS/files_DAVKS/master/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("DAVKS_Files/"..name,"r")
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevDAVKS(msg) then
local name_t = {string.match(text, "^(تعطيل ملف) (.*)(.lua)$")}
local file = name_t[2]..'.lua'
local file_bot = io.open("DAVKS_Files/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/DAVKS/files_DAVKS/master/files_DAVKS/"..file)
if res == 200 then
os.execute("rm -fr DAVKS_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DAVKS.lua')  
else
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevDAVKS(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/DAVKS/files_DAVKS/master/files_DAVKS/"..file)
if res == 200 then
local chek = io.open("DAVKS_Files/"..file,'w+')
...
if text == "مسح جميع الملفات" and DevDAVKS(msg) then
os.execute("rm -fr DAVKS_Files/*")
...
[⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/BxxDx)
     
[⌔︙ DAVKS Developer .](http://t.me/eeeeeeB)
]]
send(msg.chat_id_, msg.id_,Text)
end
...
inline = {
{{text = '⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/BxxDx'}},
}
...
inline = {
{{text = '⌔︙ DAVKS 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/BxxDx'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
local Name_Bot = (database:get(bot_id.."DAVKS:Name:Bot") or "كراند")
